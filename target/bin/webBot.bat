C:\Users\JekaJops\IntelliJIDEAProjects\ExampleTelegramBot_deploy\target\bin\webBot.bat@REM ----------------------------------------------------------------------------
...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="webBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" App %CMD_LINE_ARGS%
